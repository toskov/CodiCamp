...
Menu::Menu(IND_Entity2dManager  *myI)
{
	...
	if (!myI->_animationManager->addToSurface(mAnimationRobot, "../SpaceGame/resources/animations/robot.xml", IND_ALPHA, IND_32)) return 0;
/*
	// Character robot
